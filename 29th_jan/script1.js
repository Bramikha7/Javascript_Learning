...
for (let i = 0; i < employees.length; i = i + 1) {
    ...
    // step 2: want to add emp name , role, and email by destructuring
    let { name, role, email } = employees[i];
    console.log(name, role, email);

    // step 3: open three separate span -> innerText -> name, role and email
    ...
    // step 4: i need to append name, role and email to the myCard
    ...
    // todo : step 4: i want to append each employee card to the Container
